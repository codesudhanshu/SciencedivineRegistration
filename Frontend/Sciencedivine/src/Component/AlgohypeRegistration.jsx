...
const AlgohypeRegistration = () => {
   ...
   const submitdata = () =>{
    axios.post('https://sciencedivine-registration-app.vercel.app/api/reception/registration',{name,email,address,phonenumber})
   ...
   useEffect(() => {
     async function fetchUsers() { 
       try {
         const response = await axios.get('https://sciencedivine-registration-app.vercel.app/api/reception/registrationfetch');
